$(document).ready(function() {
    //кнопка в шапке
    $('.profil-control-clk').click(function(e) {
        e.preventDefault();
        $('.modal-profil-control').fadeIn();
    });

    $(document).mouseup(function(e) {
        var popup = $('.modal-profil-control');
        if (e.target != popup[0] && popup.has(e.target).length === 0) {
            $('.modal-profil-control').fadeOut();
        }
    });
    //Маски
    jQuery(function($) {
        ...
        $("#issued-at").mask("99-99-9999");
        $("#code").mask("999-999");
        $(".data-gen").mask("99-99-9999");
    });
});
